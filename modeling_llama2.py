...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # start jhchen
        return attn_output, attn_weights, past_key_value, all_attn
        # end jhchen
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if not return_dict:
            # start jhchen
            return tuple(v for v in [hidden_states, next_cache, all_hidden_states, all_self_attns, all_attn] if v is not None)
            # end jhchen
